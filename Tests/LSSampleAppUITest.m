...
- (void)testToVerifyAddressBookFunctionalityForFirstTwoUsers
{
    ...
    [tester tapViewWithAccessibilityLabel:@"New"];
    [tester waitForViewWithAccessibilityLabel:[LYRUITestUser testUserWithNumber:1].fullName];
}
...
-(void)testToVerifyStartingAConversationWithTwoContacts
{
    ...
    [self startConversationWithUsers:@[[LYRUITestUser testUserWithNumber:2]]];
}
...
-(void)testToVerifyConversationPersistenceFunctionality
{
    ...
    [tester waitForViewWithAccessibilityLabel:[self conversationCellLabelForParticipants:@[[LYRUITestUser testUserWithNumber:2].email]]];
}
...
- (void)testToVerifySentMessagePersistence
{
    ...
    [self.testInterface registerUser:[LYRUITestUser testUserWithNumber:1]];
    [tester waitForViewWithAccessibilityLabel:[self conversationCellLabelForParticipants:@[[LYRUITestUser testUserWithNumber:2].email]]];
    [tester tapViewWithAccessibilityLabel:[self conversationCellLabelForParticipants:@[[LYRUITestUser testUserWithNumber:2].email]]];
    
    [tester waitForViewWithAccessibilityLabel:[self messageCellLabelForText:@"Hello" andUser:[LYRUITestUser testUserWithNumber:1].fullName]];
    [tester waitForViewWithAccessibilityLabel:[self messageCellLabelForText:@"This is a test message" andUser:[LYRUITestUser testUserWithNumber:1].fullName]];
    [tester waitForViewWithAccessibilityLabel:[self messageCellLabelForText:@"This is another test message" andUser:[LYRUITestUser testUserWithNumber:1].fullName]];
}
...
- (void)testToVerifyThreeNewConversationsAreDisplayedInconversationList
{
    ...
    [self.testInterface registerUser:[LYRUITestUser testUserWithNumber:3]];
    [self.testInterface logout];
