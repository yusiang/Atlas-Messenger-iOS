...
@implementation LYRBase64Serialization
...
{
    NSString *base64EncodedStringWithoutPadding = [[encodedString stringByReplacingOccurrencesOfString:@"-" withString:@"+"]
                                                   stringByReplacingOccurrencesOfString:@"_" withString:@"/"];
    NSUInteger requiredLength = (NSUInteger)(4 * ceil((float)[base64EncodedStringWithoutPadding length] / 4.0));
    NSString *base64String = [base64EncodedStringWithoutPadding stringByPaddingToLength:requiredLength withString:@"=" startingAtIndex:0];
