//
//  LYRConcurrentOperationStateMachine.h
//  LayerKit
//
//  Created by Blake Watters on 4/29/14.
//  Copyright (c) 2014 Layer Inc. All rights reserved.
//
// Adapted from `RKOperationStateMachine` from RestKit
// Original implementation by Blake Watters on 4/11/13.
...
/**
 The `LYRConcurrentOperationStateMachine` class provides an implementation of a state machine that is suitable for implementing a concurrent `NSOperation` subclass via composition. The concurrency mechanism is a dispatch queue. The state machine takes care of correctly implementing all aspects of a concurrent `NSOperation` including:
 ...
 */
@interface LYRConcurrentOperationStateMachine : NSObject
 ...
 */
extern NSString *const LYRConcurrentOperationFailureException;
